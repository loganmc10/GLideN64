...
#define glFramebufferFetchBarrierEXT(...) CHECKED_GL_FUNCTION(g_glFramebufferFetchBarrierEXT, __VA_ARGS__)
...
extern PFNGLFRAMEBUFFERFETCHBARRIEREXTPROC g_glFramebufferFetchBarrierEXT;
